      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-cyan-500/15 bg-gradient-to-r from-cyan-500/[0.08] via-[#0b111c] to-emerald-500/[0.06] p-5 sm:p-7">
          <div className="grid items-center gap-5 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-cyan-300">[04 // {dict.quickLookup.badge}]</p>
              <h2 className="font-display mt-2 text-2xl font-extrabold text-white sm:text-3xl">{dict.quickLookup.title}</h2>
              <p className="mt-2 text-sm text-slate-400">{dict.quickLookup.description}</p>
            </div>
              ...
              <form onSubmit={submit} className="flex flex-col gap-2 sm:flex-row">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    aria-label={dict.quickLookup.inputLabel}
                  />
                </div>
